...
from QiEFengXun.proxy.db import REDISCLIENT


class QiefengxunSpiderMiddleware(object):
...
class QiefengxunDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class ProxyMiddleware(object):
    ...
    def process_response(self, request, response, spider):
        ...
        if response.status == 403:
            ...
            # 将失败的请求重新加入
            spider.logger.info("代理失效，为请求更换代理")
            # 设置代理IP=None
